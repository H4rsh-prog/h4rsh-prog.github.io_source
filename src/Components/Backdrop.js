...
export default function Backdrop() {
    useEffect(() => {
        ...
        gsap.timeline().fromTo("#box", {width:0, height:"10%", opacity: 0, outline:"0rem solid var(--accent-color)"}, {width: "97%", opacity: 1, duration: 1.5, ease: "power4.out"})
    ...
    return (
        <div id='backdrop' style={{height:"100%", width:"100%", position:"fixed", zIndex: -2, backgroundColor:"var(--primary-color)"}}>
            <div id="box" className="row m-3" style={{position:"fixed", backgroundColor:"var(--secondary-color)", height:"95%", borderRadius:"2rem", outline:".5rem solid var(--accent-color)", outlineOffset:"-1rem", zIndex:-1, overflow:"hidden"}}>
                <NavBar/>                
