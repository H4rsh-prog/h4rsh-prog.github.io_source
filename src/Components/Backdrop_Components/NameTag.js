...
import { textPathContext, browserContext } from "../../App";
...
export default function NameTag() {
    ...
    return (
        <div ref={display.wrapper} style={{width : browser.DPI=="MOBILE"? "100%" : "28rem", height:"8rem"}}>
            <div ref={display.logo_anchor_wrapper} className="pt-5 pb-5" style={{position: browser.DPI == "MOBILE" ? "relative" : "absolute", width: browser.DPI == "MOBILE" ? "100%" : "28rem", height:"8rem", backgroundColor:"var(--primary-color)", outline:".5rem solid var(--secondary-color)", border:".5rem solid var(--accent-color)", outlineOffset:"-1rem", zIndex:0}}>
